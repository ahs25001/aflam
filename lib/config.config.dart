...
import 'features/home/domain/use_cases/get_new_releases_useCase.dart' as _i13;
import 'features/home/domain/use_cases/get_popular_useCase.dart' as _i14;
import 'features/home/domain/use_cases/get_recommended_useCase.dart' as _i15;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i12.GetMovieDetailsUseCase>(
        () => _i12.GetMovieDetailsUseCase(gh<_i10.MovieDetailsRepo>()));
    gh.factory<_i13.GetNewReleasesUseCase>(
        () => _i13.GetNewReleasesUseCase(gh<_i6.HomeRepo>()));
    gh.factory<_i14.GetPopularUseCase>(
        () => _i14.GetPopularUseCase(gh<_i6.HomeRepo>()));
    gh.factory<_i15.GetRecommendedUseCase>(
        () => _i15.GetRecommendedUseCase(gh<_i6.HomeRepo>()));
    gh.factory<_i16.HomeBloc>(() => _i16.HomeBloc(
          gh<_i14.GetPopularUseCase>(),
          gh<_i13.GetNewReleasesUseCase>(),
          gh<_i15.GetRecommendedUseCase>(),
        ));
    return this;
  }
}
